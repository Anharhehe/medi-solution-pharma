...
import { Search, Filter, Star, Award, ShieldCheck, Clock, Heart, ChevronRight, Grid3X3, List, Leaf } from 'lucide-react';

interface NutraceuticalProduct {
  id: number;
  productName: string;
  category: string;
  ...
  featured: boolean;
  rating: number;
  veterinaryPrescriptionRequired: boolean;
}
...
export default function NutraceuticalsPage() {
  ...
  // Filter and sort nutraceuticals
  const filteredNutraceuticals = nutraceuticals
    .filter((product) => {
      const matchesSearch = product.productName.toLowerCase().includes(searchTerm.toLowerCase()) ||
                           product.activeIngredient.toLowerCase().includes(searchTerm.toLowerCase()) ||
                           product.manufacturer.toLowerCase().includes(searchTerm.toLowerCase());
      const matchesCategory = selectedCategory === 'all' || product.targetAnimals.some((animal) => 
  ...
  const categories: string[] = ['all', 'poultry', 'cattle', 'livestock'];

  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-green-800 via-green-600 to-emerald-500 text-white">
        <div className="max-w-7xl mx-auto px-6 py-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-green-100 max-w-2xl lg:max-w-none leading-relaxed">
                Natural health supplements and nutritional support for enhanced animal wellness
              </p>
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center space-y-3 sm:space-y-0 sm:space-x-6 mt-6 text-green-100">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-sm lg:max-w-md">
                <img 
                  src="/nutrabanner.png" 
                  alt="Veterinary Nutraceuticals Banner" 
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-[#0B1E3F] rounded-xl shadow-lg p-4 mb-8 border border-gray-100">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="relative flex-1 min-w-0">
              ...
              <input
                type="text"
                placeholder="Search nutraceuticals..."
                className="w-full pl-8 pr-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 appearance-none bg-gray-200 text-gray-800 placeholder-gray-900"
                value={searchTerm}
            ...
            <div className="relative flex-1 min-w-0">
              ...
              <select
                className="w-full pl-8 pr-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 bg-gray-200 text-gray-800"
            ...
            {/* Sort */}
            <select
              className="flex-1 min-w-0 px-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 bg-gray-200 text-gray-800"
              value={sortBy}
        ...
        <div className={viewMode === 'grid' 
          ...
          {filteredNutraceuticals.map((product) => (
            <Link key={product.id} href={`/nutraceuticals/${product.id}`}>
              <div className={`group bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden cursor-pointer ${
                ...
                <div className={`relative bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center overflow-hidden ${
                  viewMode === 'grid' 
                ...
                <div className={`${
                  ...
                  <div className={`flex flex-wrap gap-1 ${
                    ...
                    {product.targetAnimals.slice(0, viewMode === 'grid' ? 3 : 2).map((animal) => (
                    ...
                    {product.targetAnimals.length > (viewMode === 'grid' ? 3 : 2) && (
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className={`text-gray-500 ${
                        viewMode === 'grid' ? 'text-xs' : 'text-sm'
                      }`}>{product.packSize} • {product.dosageForm}</div>
                    </div>
                    
                    {product.veterinaryPrescriptionRequired && (
                  ...
                  {product.withdrawalPeriod.meat !== "0 days" && (
                    <div className={`border-t border-gray-100 ${
                      ...
                      <div className={`flex items-center text-gray-500 ${
                        ...
                        Withdrawal: {product.withdrawalPeriod.meat} (meat)
                      </div>
                    </div>
                  )}
        ...
        {filteredNutraceuticals.length > 0 && (
          <div className="mt-12 text-center">
            <p className="text-gray-600">
              Showing {filteredNutraceuticals.length} of {nutraceuticals.length} nutraceuticals
            </p>
          </div>
        )}
      </div>
